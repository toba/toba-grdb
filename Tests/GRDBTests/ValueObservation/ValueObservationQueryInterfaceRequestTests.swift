...
class ValueObservationQueryInterfaceRequestTests: GRDBTestCase {
    ...
    func testOneRowWithPrefetchedRows() throws {
        ...
        XCTAssertEqual(
            results[2]!.prefetchedRows["children"],
            [
        ...
        XCTAssertEqual(
            results[3]!.prefetchedRows["children"],
            [
        ...
        XCTAssertEqual(
            results[4]!.prefetchedRows["children"],
            [
                ["id": 1, "parentId": 1, "name": "fooA2", "grdb_parentId": 1],
                ["id": 2, "parentId": 1, "name": "fooB", "grdb_parentId": 1],
            ])
    ...
    func testAllRowsWithPrefetchedRows() throws {
        ...
        XCTAssertEqual(
            results[2][0].prefetchedRows["children"],
            [
                ["id": 1, "parentId": 1, "name": "fooA", "grdb_parentId": 1],
                ["id": 2, "parentId": 1, "name": "fooB", "grdb_parentId": 1],
            ])
        ...
        XCTAssertEqual(
            results[2][1].prefetchedRows["children"],
            [
        ...
        XCTAssertEqual(
            results[3][0].prefetchedRows["children"],
            [
                ["id": 1, "parentId": 1, "name": "fooA2", "grdb_parentId": 1],
                ["id": 2, "parentId": 1, "name": "fooB", "grdb_parentId": 1],
            ])
        ...
        XCTAssertEqual(
            results[3][1].prefetchedRows["children"],
            [
                ["id": 3, "parentId": 2, "name": "barA", "grdb_parentId": 2]
            ])
        ...
        XCTAssertEqual(
            results[4][0].prefetchedRows["children"],
            [
                ["id": 1, "parentId": 1, "name": "fooA2", "grdb_parentId": 1],
                ["id": 2, "parentId": 1, "name": "fooB", "grdb_parentId": 1],
            ])
        ...
        XCTAssertEqual(
            results[4][1].prefetchedRows["children"],
            [
                ["id": 3, "parentId": 2, "name": "barA", "grdb_parentId": 2]
            ])
        XCTAssertEqual(results[4][2].unscoped, ["id": 3, "name": "baz"])
        XCTAssertEqual(
            results[4][2].prefetchedRows["children"],
            [
    ...
    func testOneRecordWithPrefetchedRows() throws {
        ...
        try assertValueObservation(
            ...
            records: [
                nil,
                ParentInfo(parent: Parent(id: 1, name: "foo"), children: []),
                ParentInfo(
                ...
                ParentInfo(parent: Parent(id: 2, name: "bar"), children: []),
            ],
            setup: setup,
        ...
        try assertValueObservation(
            ValueObservation
                .trackingConstantRegion { db in try SendableRow.fetchOne(db, request) }
                .removeDuplicates()
                .map { row in try row.map { try ParentInfo(row: $0.row) } },
            records: [
                nil,
                ParentInfo(parent: Parent(id: 1, name: "foo"), children: []),
                ParentInfo(
    ...
    func testAllRecordsWithPrefetchedRows() throws {
            ...
            records: [
                ...
                [
                    ...
                    ParentInfo(
                        ...
                        children: [Child(id: 3, parentId: 2, name: "barA")]),
                ],
                [
                    ParentInfo(
                        parent: Parent(id: 1, name: "foo"),
                ...
                [
                    ...
                    ParentInfo(
                        ...
                        children: [Child(id: 4, parentId: 3, name: "bazA")]),
                ],
                [
                    ParentInfo(parent: Parent(id: 2, name: "bar"), children: []),
                    ParentInfo(parent: Parent(id: 3, name: "baz"), children: []),
                ],
            ],
            setup: setup,
            recordedUpdates: performDatabaseModifications)
        ...
        try assertValueObservation(
            ValueObservation
                .trackingConstantRegion { db in try SendableRow.fetchAll(db, request) }
                .removeDuplicates()
                .map { rows in try rows.map { try ParentInfo(row: $0.row) } },
            records: [
                [],
                [
                    ParentInfo(parent: Parent(id: 1, name: "foo"), children: []),

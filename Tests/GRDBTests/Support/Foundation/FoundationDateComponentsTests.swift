...
class FoundationDateComponentsTests: GRDBTestCase {
    ...
    func testDatabaseDateComponentsFormatHM() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            try db.execute(
                ...
                arguments: [DatabaseDateComponents(dateComponents, format: .HM)])

            let string = try String.fetchOne(db, sql: "SELECT creationDate from dates")!
            XCTAssertEqual(string, "10:11")

            let databaseDateComponents = try DatabaseDateComponents.fetchOne(
                db, sql: "SELECT creationDate FROM dates")!
    ...
    func testDatabaseDateComponentsFormatHMS() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            try db.execute(
                sql: "INSERT INTO dates (creationDate) VALUES (?)",
                arguments: [DatabaseDateComponents(dateComponents, format: .HMS)])
    ...
    func testDatabaseDateComponentsFormatHMSS() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            try db.execute(
                sql: "INSERT INTO dates (creationDate) VALUES (?)",
                arguments: [DatabaseDateComponents(dateComponents, format: .HMSS)])
            ...
            XCTAssertEqual(databaseDateComponents.dateComponents.second, dateComponents.second)
            XCTAssertEqual(
                round(Double(databaseDateComponents.dateComponents.nanosecond!) / 1.0e6),
    ...
    func testDatabaseDateComponentsFormatYMD() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            try db.execute(
                sql: "INSERT INTO dates (creationDate) VALUES (?)",
                arguments: [DatabaseDateComponents(dateComponents, format: .YMD)])
    ...
    func testDatabaseDateComponentsFormatYMD_HM() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            try db.execute(
                sql: "INSERT INTO dates (creationDate) VALUES (?)",
                arguments: [DatabaseDateComponents(dateComponents, format: .YMD_HM)])
    ...
    func testDatabaseDateComponentsFormatYMD_HMS() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            try db.execute(
                sql: "INSERT INTO dates (creationDate) VALUES (?)",
                arguments: [DatabaseDateComponents(dateComponents, format: .YMD_HMS)])
    ...
    func testDatabaseDateComponentsFormatYMD_HMSS() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            try db.execute(
                sql: "INSERT INTO dates (creationDate) VALUES (?)",
                arguments: [DatabaseDateComponents(dateComponents, format: .YMD_HMSS)])
    ...
    func testDatabaseDateComponentsFormatIso8601YMD_HM() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            dateComponents.nanosecond = 123_456_789
            try db.execute(
                sql: "INSERT INTO dates (creationDate) VALUES (?)", arguments: ["1973-09-18T10:11"])
    ...
    func testDatabaseDateComponentsFormatIso8601YMD_HMSS() throws {
        ...
        try dbQueue.inDatabase { db in
            ...
            try db.execute(
                sql: "INSERT INTO dates (creationDate) VALUES (?)",
                arguments: ["1973-09-18T10:11:12.123"])
    ...
    func testDatabaseDateComponentsParsing() {
        func assertParse(
            _ string: String,
            _ dateComponent: DatabaseDateComponents,
            file: StaticString = #filePath,
            line: UInt = #line
        ) {
            do {
                // Test DatabaseValueConvertible adoption
                guard let parsed = DatabaseDateComponents.fromDatabaseValue(string.databaseValue)
                else {
                ...
                XCTAssertEqual(
                    parsed.dateComponents, dateComponent.dateComponents, file: file, line: line)
            }
            do {
        ...
        assertParse(
            ...
            DatabaseDateComponents(
                DateComponents(
                    year: 0, month: 1, day: 1, hour: nil, minute: nil, second: nil, nanosecond: nil),
                format: .YMD))
        assertParse(
            "2018-12-31",
            DatabaseDateComponents(
                DateComponents(
                    year: 2018, month: 12, day: 31, hour: nil, minute: nil, second: nil,
                    nanosecond: nil),
                format: .YMD))
        assertParse(
            "2018-04-21 00:00",
        ...
        assertParse(
            ...
            DatabaseDateComponents(
                DateComponents(
                    year: 2018, month: 04, day: 21, hour: 23, minute: 59, second: nil,
                    nanosecond: nil),
                format: .YMD_HM))
        assertParse(
            "2018-04-21 00:00:00",
            DatabaseDateComponents(
                DateComponents(
                    year: 2018, month: 04, day: 21, hour: 0, minute: 0, second: 0, nanosecond: nil),
                format: .YMD_HMS))
        assertParse(
            "2018-04-21T23:59:59",
            DatabaseDateComponents(
                DateComponents(
                    year: 2018, month: 04, day: 21, hour: 23, minute: 59, second: 59,
                    nanosecond: nil),
                format: .YMD_HMS))
        assertParse(
            ...
            DatabaseDateComponents(
                DateComponents(
                    year: 2018, month: 04, day: 21, hour: 0, minute: 0, second: 0, nanosecond: 0),
                format: .YMD_HMSS))
        assertParse(
        ...
        assertParse(
            ...
            DatabaseDateComponents(
                DateComponents(
                    year: 2018, month: 04, day: 21, hour: 0, minute: 0, second: 0,
        ...
        assertParse(
            ...
            DatabaseDateComponents(
                DateComponents(
                    year: nil, month: nil, day: nil, hour: 0, minute: 0, second: nil,
                    nanosecond: nil),
                format: .HM))
        assertParse(
            "23:59",
            DatabaseDateComponents(
                DateComponents(
                    year: nil, month: nil, day: nil, hour: 23, minute: 59, second: nil,
                    nanosecond: nil),
                format: .HM))
        assertParse(
            "23:59Z",
        ...
        assertParse(
            ...
            DatabaseDateComponents(
                DateComponents(
                    year: nil, month: nil, day: nil, hour: 0, minute: 0, second: 0, nanosecond: nil),
                format: .HMS))
        assertParse(
            "23:59:59",
            DatabaseDateComponents(
                DateComponents(
                    year: nil, month: nil, day: nil, hour: 23, minute: 59, second: 59,
                    nanosecond: nil),
                format: .HMS))
        assertParse(
            "00:00:00.0",
            DatabaseDateComponents(
                DateComponents(
                    year: nil, month: nil, day: nil, hour: 0, minute: 0, second: 0, nanosecond: 0),
                format: .HMSS))
        assertParse(
            "23:59:59.9",
            DatabaseDateComponents(
        ...
        assertParse(
            ...
            DatabaseDateComponents(
                DateComponents(
                    year: nil, month: nil, day: nil, hour: 0, minute: 0, second: 0,
                    nanosecond: 10_000_000),
                format: .HMSS))
        assertParse(
            "23:59:59.99",
    ...
    func testJSONEncodingOfDatabaseDateComponents() throws {
        ...
        let record = Record(date: DatabaseDateComponents(
            DateComponents(year: 2018, month: 12, day: 31), format: .YMD))
